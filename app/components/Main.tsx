...
const Main = () => {
  ...
  return (
    <section id="Main" className="h-full pt-32  transition-all duration-1000 ">
      <div className="  h-full">
        <div className="flex flex-col-reverse  xl:flex-row-reverse  items-center justify-around xl:pt-8 transition-all duration-1000 ease-in-out  ">
          <div className="  text-center xl:text-left xl:mr-24 mt-5  ">
            ...
            <h2 className=" text-5xl xl:text-6xl align-text-top mt-2 xl:m-0 mb-6 text-light-textPrimary dark:text-dark-textPrimary font-header font-bold ">
              Hei. Mitt navn er
              <br />
              <span className=" text-lime-900 dark:text-dark-ekstra ">
                Stein
              </span>
            </h2>
